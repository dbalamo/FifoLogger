...
FifoLogger.log(LogLevel.DEBUG, "this will not be visible, because the default log level is INFO")
FifoLogger.log(LogLevel.INFO, "1 - TEST ME UP 1 2 3", testAttachedObj1, testAttachedObj2)
