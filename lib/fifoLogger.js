...
class FifoLogger {
    static init(flc) {
        ...
        FifoLogger._minLogLevel = flc.minLogLevel ? flc.minLogLevel : exports.LogLevel.INFO;
    ...
    static log(logLevel, message, ...optionalParams) {
        ...
        if (logLevel >= FifoLogger._minLogLevel) {
            const msg = FifoLogger.buildMessage(FifoLogger._hasColoredConsole, FifoLogger._jsonMode, logLevel, message, optionalParams);
...
FifoLogger._dequeueTimeoutMs = exports.DequeueTimeoutMs.STANDARD;
FifoLogger._logPrefix = '';
FifoLogger._hasColoredConsole = typeof module !== 'undefined' && module.exports;
FifoLogger._minLogLevel = 0;
FifoLogger._maxEventLength = 0;
FifoLogger._filename = '';
FifoLogger._jsonMode = false;
//private variables
FifoLogger._logWriteStream = null;
FifoLogger._logQueueItems = [];
FifoLogger._bCanWritemore = true;
